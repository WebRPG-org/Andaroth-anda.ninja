...
Scene_Base.prototype.score = function() {
};
...
Scene_Title.prototype.createCommandWindow = function() {
    ...
    this._commandWindow.setHandler('score',  this.commandScore.bind(this)); // homemade
...
Scene_Title.prototype.commandScore = function() {
    this._commandWindow.close();
...
Scene_MenuBase.prototype.score = function() {
    Scene_Base.prototype.score.call(this);
    this.createBackground();
    this.updateActor();
    this.createWindowLayer();
};
...
function Scene_FileScore() {
    this.initialize.apply(this, arguments);
}

Scene_FileScore.prototype = Object.create(Scene_MenuBase.prototype);
Scene_FileScore.prototype.constructor = Scene_File;

Scene_FileScore.prototype.initialize = function() {
    Scene_MenuBase.prototype.initialize.call(this);
};

Scene_FileScore.prototype.create = function() {
    Scene_MenuBase.prototype.create.call(this);
...
Scene_FileScore.prototype.start = function() {
    Scene_MenuBase.prototype.start.call(this);
    this._listWindow.refresh();
};

Scene_FileScore.prototype.savefileId = function() {
    return this._listWindow.index() + 1;
};

Scene_FileScore.prototype.createHelpWindow = function() {
    this._helpWindow = new Window_Help(1);
    this._helpWindow.setText(this.helpWindowText());
    this.addWindow(this._helpWindow);
};

Scene_FileScore.prototype.createListWindow = function() {
    var x = 0;
...
Scene_FileScore.prototype.createScoreWindow = function() {
    var x = 0;
    var y = this._helpWindow.height;
    var width = Graphics.boxWidth;
    var height = Graphics.boxHeight - y;
    this._listWindow = new Window_ScorefileList(x, y, width, height);
    this._listWindow.setHandler('ok', this.popScene.bind(this));
    this._listWindow.setHandler('cancel', this.popScene.bind(this));
    // this._listWindow.select(this.firstSavefileIndex());
    // this._listWindow.setTopRow(this.firstSavefileIndex() - 2);
    // this._listWindow.setMode(this.mode());
...
Scene_FileScore.prototype.mode = function() {
    return null;
};

Scene_FileScore.prototype.activateListWindow = function() {
    this._listWindow.activate();
};

Scene_FileScore.prototype.helpWindowText = function() {
    return '';
};

Scene_FileScore.prototype.firstSavefileIndex = function() {
    return 0;
};

Scene_FileScore.prototype.onSavefileOk = function() {
};
...
Scene_File.prototype.score = function() {
    Scene_MenuBase.prototype.create.call(this);
    DataManager.loadAllSavefileImages();
    this.createHelpWindow();
    this.createScoreWindow();
...
Scene_File.prototype.createScoreWindow = function() {
    var x = 0;
    var y = this._helpWindow.height;
    var width = Graphics.boxWidth;
    var height = Graphics.boxHeight - y;
    this._listWindow = new Window_ScorefileList(x, y, width, height);
    // this._listWindow.setHandler('ok',  this.onScoreOk.bind(this));
    this._listWindow.setHandler('ok',  this.onScoreOk.bind(this));
    this._listWindow.setHandler('cancel', this.popScene.bind(this));
    this._listWindow.select(this.firstSavefileIndex());
    this._listWindow.setTopRow(this.firstSavefileIndex() - 2);
...
Scene_File.prototype.onScoreOk = function() {
    var x = 0;
    var y = this._helpWindow.height;
    var width = Graphics.boxWidth;
    var height = Graphics.boxHeight - y;
    this._scoreWindow = new Window_OneScore(x,y,width,height);
    this._listWindow.setHandler('ok',  this.popScene.bind(this));
    this._listWindow.setHandler('cancel', this.popScene.bind(this));
    this.addWindow(this._listWindow);
}
...
//-----------------------------------------------------------------------------
// Scene_Score (homemade)
//
// The scene class of the high score screen.

function Scene_Score() {
    this.initialize.apply(this, arguments);
}

Scene_Score.prototype = Object.create(Scene_FileScore.prototype);
...
Scene_Score.prototype.terminate = function() {
...
Scene_Score.prototype.mode = function() {
    return 'score';
};

Scene_Score.prototype.helpWindowText = function() {
    return "Tableau des scores :";
};

Scene_Score.prototype.firstSavefileIndex = function() {
    return DataManager.latestSavefileId() - 2;
};

Scene_Score.prototype.onSavefileOk = function() {
    Scene_File.prototype.onSavefileOk.call(this);
...
Scene_Score.prototype.onLoadSuccess = function() {
};

Scene_Score.prototype.onLoadFailure = function() {
};

Scene_Score.prototype.reloadMapIfUpdated = function() {
